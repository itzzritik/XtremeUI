...
import "./spinner.scss";
import { ESpinnerSize, type ISpinnerProps } from "./types";
...
export const Spinner = forwardRef<HTMLDivElement, ISpinnerProps>((props, ref) => {
	...
	const SpinnerClsx = clsx("xtrSpinner", fullpage && "fullpage", className);

	return (
		<div ref={ref} className={SpinnerClsx} style={{ ["--spinnerSize" as string]: spinnerSize }} role="progressbar">
